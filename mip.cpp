    ...
    for (int y = 0; y <= mip_size; ++y) {
        ...
        for (int x = 0; x <= mip_size; ++x) {
            ...
            for (double z = -r; z <= r; z += spacing_z) {
                ...
                // 投影経路上の座標を回転
                double world_x = tx * rotation_matrix[0][0] + ty * rotation_matrix[0][1] + tz * rotation_matrix[0][2];
                double world_y = tx * rotation_matrix[1][0] + ty * rotation_matrix[1][1] + tz * rotation_matrix[1][2];
                double world_z = tx * rotation_matrix[2][0] + ty * rotation_matrix[2][1] + tz * rotation_matrix[2][2];
